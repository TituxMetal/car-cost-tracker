# car-cost-tracker - NestJS API + Astro Frontend
...
- **API**: `ghcr.io/TituxMetal/car-cost-tracker-api`
- **Web**: `ghcr.io/TituxMetal/car-cost-tracker-web`
...
- `ghcr.io/TituxMetal/car-cost-tracker-api:latest`
- `ghcr.io/TituxMetal/car-cost-tracker-web:latest`
...
- **Local Development**: Images built with `scripts/docker-build.sh` use Docker Hub
  (`lgdweb/car-cost-tracker-*`) for quick testing and iteration
- **Production Releases**: CI automatically builds and pushes to GitHub Container Registry
  (`ghcr.io/TituxMetal/car-cost-tracker-*`) for official releases
