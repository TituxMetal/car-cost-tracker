...
import { GetBudgetByVehicleUseCase } from './GetBudgetByVehicle.uc'

describe('GetBudgetByVehicleUseCase', () => {
  let useCase: GetBudgetByVehicleUseCase
  let mockRepository: {
  ...
  beforeEach(() => {
    ...
    useCase = new GetBudgetByVehicleUseCase(
  ...
  describe('execute', () => {
    it('should return the mapped DTO when vehicle and budget exist', async () => {
